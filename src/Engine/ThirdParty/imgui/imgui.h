...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderFloat2(const char* label, float v[2], float v_min[2], float v_max[2], const char* display_format = "%.3f", float power = 1.0f);
    IMGUI_API bool          SliderFloat3(const char* label, float v[3], float v_min[3], float v_max[3], const char* display_format = "%.3f", float power = 1.0f);
